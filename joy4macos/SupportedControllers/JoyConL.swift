...
class JoyConL: DSUController {
    
    let availableButtons: [JoyCon.Button] = [.Up, .Right, .Down, .Left, .LeftSL, .LeftSR, .L, .ZL, .Minus, .Capture, .LStick]
    ...
    override func updateControllerVariables() {
        ...
        buttons2 |= (btnState[.LeftSL] ?? false)    ?   0x01 << 1 : 0x00 // R2
        buttons2 |= (btnState[.L] ?? false)         ?   0x01 << 2 : 0x00 // L1
        buttons2 |= (btnState[.LeftSR] ?? false)    ?   0x01 << 3 : 0x00 // R1
        ...
        psButton = (btnState[.Capture] ?? false) ?      0xFF      : 0x00 // PS
        ...
        buttonR1 = UInt8(((btnState[.LeftSR] ?? false) ? 1 : 0) * 255)
        buttonL1 = UInt8(((btnState[.L] ?? false) ? 1 : 0) * 255)
        
        buttonR2 = UInt8(((btnState[.LeftSL] ?? false) ? 1 : 0) * 255)
